...
- [The Slab Allocator: An Object-Caching Kernel Memory Allocator](papers/os/slab-allocator.pdf) (1994)

  This paper presents a comprehensive design overview of the SunOS 5.4 kernel
  memory allocator.

- [What Every Programmer Should Know About Memory](papers/os/cpumemory.pdf) (2007)
...
- [What Every Systems Programmer Should Know About Concurrency](papers/os/concurrency-primer.pdf) (2018)
...
- [Conflict-free Replicated Data Types](papers/replication/crdt.pdf) (SSS, 2011)
...
- [Granularity of Locks and Degrees of Consistency in a Shared Data Base](papers/transaction/granularity-of-locks.pdf) (IBM, 1975)
...
- [The Notion of Consistency and Predicate Locks in a Database System](papers/transaction/predicate-locks.pdf) (IBM, 1976)
...
- [Time, Clocks, and the Ordering of Events in a Distributed System](papers/distributed-transaction/logical-clocks.pdf) (Lamport, 1978)
...
- [Logical Physical Clocks and Consistent Snapshots in Globally Distributed Databases](papers/distributed-transaction/hybrid-logical-clocks.pdf) (OPODIS, 2014)
...
- [The Google File System](papers/fs/gfs-sosp03.pdf) (SOSP, 2003)
...
- [Finding a needle in Haystack: Facebook’s photo storage](papers/blob/haystack-osdi10.pdf) (OSDI, 2010)

- [f4: Facebook’s Warm BLOB Storage System](papers/blob/f4-osdi14.pdf) (OSDI, 2014)

# Key-Value Storage

## Papers

- [Dynamo: Amazon’s Highly Available Key-value Store](papers/kv/dynamo-sosp07.pdf) (SOSP, 2007)
...
- [Anna: A KVS for Any Scale](papers/kv/anna-ieee18.pdf) (ICDE, 2018)

- [Autoscaling Tiered Cloud Storage in Anna](papers/kv/anna-vldb19.pdf) (VLDB, 2019)

- [Transactional Causal Consistency for Serverless Computing](papers/kv/anna-sigmod20.pdf) (SIGMOD, 2020)

# Structured Storage

## Papers

- [Bigtable: A Distributed Storage System for Structured Data](papers/structured/bigtable-osdi06.pdf) (OSDI, 2006)
...
- [Weaving Relations for Cache Performance](papers/column-oriented/pax-vldb01.pdf) (VLDB, 2001)
...
- [C-Store: A Column-oriented DBMS](papers/column-oriented/c-store-vldb05.pdf) (VLDB, 2005)

  This paper presents the design of a read-optimized relational DBMS that stores
  data by column.

- [MonetDB/X100: Hyper-Pipelining Query Execution](papers/column-oriented/monetdb-cidr05.pdf) (CIDR, 2005)
...
- [The Design and Implementation of Modern Column-Oriented Database Systems](papers/column-oriented/modern-column-stores.pdf) (2013)
...
- [Megastore: Providing Scalable, Highly Available Storage for Interactive Services](papers/newsql/megastore-cidr11.pdf) (CIDR, 2011)
...
- [Spanner: Google’s Globally-Distributed Database](papers/newsql/spanner-osdi12.pdf) (OSDI, 2012)

  This paper presents Spanner, a scalable, multi-version, globally-distributed,
  and synchronously-replicated database.

- [F1: A Distributed SQL Database That Scales](papers/newsql/f1-vldb13.pdf) (VLDB, 2013)
...
- [Online, Asynchronous Schema Change in F1](papers/newsql/f1-schema-vldb13.pdf) (VLDB, 2013)
...
- [Spanner: Becoming a SQL System](papers/newsql/spanner-sigmod17.pdf) (SIGMOD, 2017)
...
- [Amazon Aurora: Design Considerations for High Throughput Cloud-Native Relational Databases](papers/newsql/aurora-sigmod17.pdf) (SIGMOD, 2017)

- [Amazon Aurora: On Avoiding Distributed Consensus for I/Os, Commits, and Membership Changes](papers/newsql/aurora-sigmod18.pdf) (SIGMOD, 2018)

- [Socrates: The New SQL Server in the Cloud](papers/newsql/socrates-sigmod19.pdf) (SIGMOD, 2019)

- [CockroachDB: The Resilient Geo-Distributed SQL Database](papers/newsql/cockroachdb-sigmod20.pdf) (SIGMOD, 2020)
...
- [TiDB: A Raft-based HTAP Database](papers/newsql/tidb-vldb20.pdf) (VLDB, 2020)
...
- [Dremel: Interactive Analysis of Web-Scale Datasets](papers/analytical/dremel-vldb10.pdf) (VLDB, 2010)

- [The Snowflake Elastic Data Warehouse](papers/analytical/snowflake-sigmod16.pdf) (SIGMOD, 2016)

- [AnalyticDB: Real-time OLAP Database System at Alibaba Cloud](papers/analytical/analyticdb-vldb19.pdf) (VLDB, 2019)

- [Procella: Unifying serving and analytical data at YouTube](papers/analytical/procella-vldb19.pdf) (VLDB, 2019)

- [Alibaba Hologres: A Cloud-Native Service for Hybrid Serving/Analytical Processing](papers/analytical/hologres-vldb20.pdf) (VLDB, 2020)

# Cluster Management

## Papers

- [An Opportunity Cost Approach for Job Assignment in a Scalable Computing Cluster](papers/cluster-management/epvm.pdf) (2000)

- [Large-scale cluster management at Google with Borg](papers/cluster-management/borg.pdf) (EuroSys, 2015)

# Lessons and Experiences

## Papers

- [What Goes Around Comes Around](papers/lessons/what-goes-around-comes-around.pdf) (2005)

- ["One Size Fits All": An Idea Whose Time Has Come and Gone](papers/lessons/one-size-fits-all.pdf) (ICDE, 2005)
